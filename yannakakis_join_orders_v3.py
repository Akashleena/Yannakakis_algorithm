...
from yannakakis_functions_v3 import apply_selection, downward_semi_join, upward_full_join
...
def run_yannakakis_with_order(dataset_file, join_order):
    ...
    print(f"Total Execution Time for Join Order {' -> '.join(join_order)}: {total_execution_time:.2f} seconds\n")
...
def plot_results(results):
    ...
    plt.savefig("yannakakis_join_order_performance_v3.png")
    print("Performance plot saved as 'yannakakis_join_order_performance_superlargedata.png'")
    plt.show()
